...
from .faults import FaultFriction as ModuleFaultFriction


class FaultFriction(FaultRheology, ModuleFaultFriction):
    """
    Abstract base class for friction constitutive model.
    """
    ...
    def __init__(self, name="faultfriction"):
        """Constructor.
        """
        FaultRheology.__init__(self, name, facility="faultfriction")
